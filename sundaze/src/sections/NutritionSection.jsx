...
import { nutrientList } from "../constants/flavorLists";
...
const NutritionSection = () => {
  ...
  return (
    <section className="nutrition-section" id="nutrition">
      ...
      />
      <img src="/images/big-img.png" alt="" className="bg-img" />
            ...
            {lists.map((nutrient, index) => (
              <div key={index} className="relative flex-1 col-center">
                <div>
                  ...
                  <p className="md:text-4xl text-2xl tracking-tighter font-bold font-paragraph">
                    {nutrient.amount}
                  </p>
                </div>
